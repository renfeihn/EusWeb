 ...
 public class ContractView extends Entity
 {
   ...
   private Set<ContractItemView> items;
   ...
   public Set<ContractItemView> getItems() {
     return this.items;
   }
   public void setItems(Set<ContractItemView> items) {
     this.items = items;
   }
   public ContractItemView getItem(String id) {
     for (ContractItemView item : this.items) {
