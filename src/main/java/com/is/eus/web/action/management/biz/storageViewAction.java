 ...
 public class storageViewAction extends EntityBaseAction
 {
   ...
   public void setStorageViewService(StorageViewService storageViewService) {
     this.storageViewService = storageViewService;
   }

   protected Class<StorageView> getEntityClass()
   {
     return StorageView.class;
   }
   ...
   public String printQuery()
   {
     ...
     try {
       this.storageViewService.print(items);
     } catch (IOException e) {
