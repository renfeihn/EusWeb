	...
	var SCSSummeryViewSearchGrid = new Ext.grid.EditorGridPanel ({
		...
		colModel:new Ext.grid.ColumnModel({
			...
			columns:[
				...
				{header:'合同对库欠交数',width:80,dataIndex:'coOwnedAmount',renderer:clsys.grid.columnrender.coOwnedAmount},
	...
	var SCSSummerySearchGrid = new Ext.grid.EditorGridPanel ({
		...
		colModel:new Ext.grid.ColumnModel({
			...
			columns:[
				...
				{header:'合同对库欠交数合计',width:80,dataIndex:'coOwnedAmount',renderer:clsys.grid.columnrender.coOwnedAmount},
